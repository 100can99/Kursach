...
exports.can = function(user) {
    ...
    res.view_dostavka = user && user.id_role <= 2 ? true : false
    res.view_eda = user && user.id_role <= 3  ? true : false
    res.view_prodazhi = user && user.id_role <= 2 ? true : false
	res.view_dostavka = user && user.id_role <= 3 ? true : false
	res.view_postavshiki = user && user.id_role <= 3 ? true : false
